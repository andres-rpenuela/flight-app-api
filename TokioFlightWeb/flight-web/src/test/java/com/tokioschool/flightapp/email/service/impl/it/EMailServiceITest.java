package com.tokioschool.flightapp.email.service.impl.it;
...
/*
    ...
    @Test
    void givenEmailDTOWithAttachment_whenSendEmailWithAttachment_thenOk() throws IOException, AddressException {
    ...
    public List<AttachmentDTO> buildAttachmentDTOMock() throws IOException {
        final String relativePathFileWithFullName = "static/images/flight-default.jpg";

        final File attachmentFile = new File(EMailServiceITest.class.getClassLoader()
